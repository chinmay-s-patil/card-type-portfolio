...
export declare class MeshVS_SymmetricPairHasher {
  constructor();
  HashCode(theNodePair: MeshVS_NodePair, theUpperBound: Standard_Integer): Standard_Integer;
  IsEqual(thePair1: MeshVS_NodePair, thePair2: MeshVS_NodePair): Standard_Boolean;
}
