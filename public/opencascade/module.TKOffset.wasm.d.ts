...
export declare class BRepOffset_Inter2d {
  constructor();
  Compute(AsDes: any, F: TopoDS_Face, NewEdges: TopTools_IndexedMapOfShape, Tol: Standard_Real, theEdgeIntEdges: TopTools_DataMapOfShapeListOfShape, theDMVV: TopTools_IndexedDataMapOfShapeListOfShape): void;
  ...
  FuseVertices(theDMVV: TopTools_IndexedDataMapOfShapeListOfShape, theAsDes: any, theImageVV: BRepAlgo_Image): Standard_Boolean;
...
export declare class BRepOffset_Tool {
  ...
  Inter3D(F1: TopoDS_Face, F2: TopoDS_Face, LInt1: TopTools_ListOfShape, LInt2: TopTools_ListOfShape, Side: TopAbs_State, RefEdge: TopoDS_Edge, RefFace1: TopoDS_Face, RefFace2: TopoDS_Face): void;
