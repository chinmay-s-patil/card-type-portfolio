...
export declare class Geom2dGcc {
  constructor();
  Unqualified(Obj: Geom2dAdaptor_Curve): Geom2dGcc_QualifiedCurve;
  Enclosing(Obj: Geom2dAdaptor_Curve): Geom2dGcc_QualifiedCurve;
  Enclosed(Obj: Geom2dAdaptor_Curve): Geom2dGcc_QualifiedCurve;
  Outside(Obj: Geom2dAdaptor_Curve): Geom2dGcc_QualifiedCurve;
}
...
export declare class Geom2dGcc_CurveTool {
  constructor();
  FirstParameter(C: Geom2dAdaptor_Curve): Standard_Real;
  LastParameter(C: Geom2dAdaptor_Curve): Standard_Real;
  EpsX(C: Geom2dAdaptor_Curve, Tol: Standard_Real): Standard_Real;
  NbSamples(C: Geom2dAdaptor_Curve): Standard_Integer;
  Value(C: Geom2dAdaptor_Curve, X: Standard_Real): gp_Pnt2d;
  D1(C: Geom2dAdaptor_Curve, U: Standard_Real, P: gp_Pnt2d, T: gp_Vec2d): void;
  D2(C: Geom2dAdaptor_Curve, U: Standard_Real, P: gp_Pnt2d, T: gp_Vec2d, N: gp_Vec2d): void;
  D3(C: Geom2dAdaptor_Curve, U: Standard_Real, P: gp_Pnt2d, T: gp_Vec2d, N: gp_Vec2d, dN: gp_Vec2d): void;
}
...
export declare class Geom2dInt_Geom2dCurveTool {
  ...
  EpsX_1(C: Adaptor2d_Curve2d): Standard_Real;
  EpsX_2(C: Adaptor2d_Curve2d, Eps_XYZ: Standard_Real): Standard_Real;
  NbSamples_1(C: Adaptor2d_Curve2d): Standard_Integer;
  NbSamples_2(C: Adaptor2d_Curve2d, U0: Standard_Real, U1: Standard_Real): Standard_Integer;
  FirstParameter(C: Adaptor2d_Curve2d): Standard_Real;
  LastParameter(C: Adaptor2d_Curve2d): Standard_Real;
  Value(C: Adaptor2d_Curve2d, X: Standard_Real): gp_Pnt2d;
  D0(C: Adaptor2d_Curve2d, U: Standard_Real, P: gp_Pnt2d): void;
  D1(C: Adaptor2d_Curve2d, U: Standard_Real, P: gp_Pnt2d, T: gp_Vec2d): void;
  D2(C: Adaptor2d_Curve2d, U: Standard_Real, P: gp_Pnt2d, T: gp_Vec2d, N: gp_Vec2d): void;
  D3(C: Adaptor2d_Curve2d, U: Standard_Real, P: gp_Pnt2d, T: gp_Vec2d, N: gp_Vec2d, V: gp_Vec2d): void;
  DN(C: Adaptor2d_Curve2d, U: Standard_Real, N: Standard_Integer): gp_Vec2d;
  NbIntervals(C: Adaptor2d_Curve2d): Standard_Integer;
  Intervals(C: Adaptor2d_Curve2d, Tab: TColStd_Array1OfReal): void;
  GetInterval(C: Adaptor2d_Curve2d, Index: Standard_Integer, Tab: TColStd_Array1OfReal, U1: Standard_Real, U2: Standard_Real): void;
...
export declare class Geom2dInt_TheProjPCurOfGInter {
  constructor();
  FindParameter_1(C: Adaptor2d_Curve2d, Pnt: gp_Pnt2d, Tol: Standard_Real): Standard_Real;
  FindParameter_2(C: Adaptor2d_Curve2d, Pnt: gp_Pnt2d, LowParameter: Standard_Real, HighParameter: Standard_Real, Tol: Standard_Real): Standard_Real;
}
...
export declare class GeomInt_IntSS {
  ...
  TreatRLine(theRL: any, theHS1: any, theHS2: any, theC3d: any, theC2d1: any, theC2d2: any, theTolReached: Standard_Real): void;
  BuildPCurves(f: Standard_Real, l: Standard_Real, Tol: Standard_Real, S: any, C: any, C2d: any): void;
  TrimILineOnSurfBoundaries(theC2d1: any, theC2d2: any, theBound1: Bnd_Box2d, theBound2: Bnd_Box2d, theArrayOfParameters: GeomInt_VectorOfReal): void;
  MakeBSpline(WL: any, ideb: Standard_Integer, ifin: Standard_Integer): any;
  MakeBSpline2d(theWLine: any, ideb: Standard_Integer, ifin: Standard_Integer, onFirst: Standard_Boolean): any;
}
