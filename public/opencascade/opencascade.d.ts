...
export declare class OSD_ThreadPool extends Standard_Transient {
  ...
  get_type_descriptor(): any;
  DynamicType(): any;
  DefaultPool(theNbThreads: number): any;
  HasThreads(): boolean;
...
export declare class OSD_Parallel {
  constructor();
  ToUseOcctThreads(): Standard_Boolean;
  SetUseOcctThreads(theToUseOcct: Standard_Boolean): void;
...
export declare class NCollection_CellFilter_InspectorXYZ {
  constructor();
  Coord(i: number, thePnt: any): Standard_Real;
...
export declare class NCollection_UtfStringTool {
  ...
  ToLocale(theWideString: wchar_t, theBuffer: string, theSizeBytes: Standard_Integer): boolean;
}

export declare class Quantity_ColorHasher {
  constructor();
  HashCode(theColor: Quantity_Color, theUpperBound: Standard_Integer): Standard_Integer;
  IsEqual(theColor1: Quantity_Color, theColor2: Quantity_Color): Standard_Boolean;
}

export declare class Quantity_ColorRGBAHasher {
  constructor();
  HashCode(theColor: Quantity_ColorRGBA, theUpperBound: Standard_Integer): Standard_Integer;
  IsEqual(theColor1: Quantity_ColorRGBA, theColor2: Quantity_ColorRGBA): Standard_Boolean;
}
