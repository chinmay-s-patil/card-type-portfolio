...
export declare class XCAFPrs_DocumentNode {
  constructor()
  HashCode(theNode: XCAFPrs_DocumentNode, theN: Standard_Integer): Standard_Integer;
  IsEqual(theNode1: XCAFPrs_DocumentNode, theNode2: XCAFPrs_DocumentNode): Standard_Boolean;
}
